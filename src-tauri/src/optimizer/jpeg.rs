...
fn get_exif_orientation(path: &Path) -> Option<u32> {
...
pub fn optimize_jpeg(input_path: &Path, output_path: &Path) -> Result<(), String> {
    ...
    // Write back optimized JPEG at quality 82
